...
#define APP_ID          @"wx207ef4929a384aab"               //APPID
#define APP_SECRET      @"d4624c36b6795d1d99dcf0547af5443d" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1280303901"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"DgMsWo3IE56Aab6rN67l5tT9lHBdFqQT"
//支付结果回调页面
#define NOTIFY_URL      @"http://wxpay.weixin.qq.com/pub_v2/pay/notify.v2.php"
//#define NOTIFY_URL @"http://www.baidu.com"
//获取服务器端支付数据地址（商户自定义）
...
//签名实例测试
- ( NSMutableDictionary *)sendPay_demo:(NSString *)orderName andOrderNumber:(NSString *)orderNumber andOrderPrice:(CGFloat)price;
