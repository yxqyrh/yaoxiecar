...
#define COMMON_BACKGROUNDCOLOR     UIColorWithRGBA(0.0f, 160.0f, 230.0f, 1.0f)//通用的页面背景颜色
#define TITLE_BACKGROUNDCOLOR      UIColorWithRGBA(255.0f, 138.0f, 0.0f, 1.0f)//title bar 导航背景颜色
#define COMMON_BTN_BACKGROUNDCOLOR UIColorWithRGBA(3.0f,123.0f,203.0f,1.0f)//通用的按钮颜色

#define STATEBAR_NAV_HEIGHT  64.0F
#define SLIDEBAR_HOME_HEIGHT   SCREEN_HEIGHT - 113
