...
- (void)showLineWithButtonWidth:(CGFloat)width
{
    ...
    _line.backgroundColor = COMMON_BTN_BACKGROUNDCOLOR;
...
- (NSArray *)getButtonsWidthWithTitles:(NSArray *)titles;
{
    ...
    for (NSString *title in titles)
    {
        NSInteger num = titles.count;
         ...
         switch (num) {
            case 1:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH]];
                break;
            case 2:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH/2]];
                break;
                case 3:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH/3]];
                break;
            case 4:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH/4]];
                break;
            case 5:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH/5]];
                break;
            case 6:
                [widths addObject:[NSNumber numberWithFloat:SCREEN_WIDTH/6]];
                break;
            default:
